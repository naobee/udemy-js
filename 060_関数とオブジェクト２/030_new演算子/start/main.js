...
// new 演算子と同じ動きをする関数
// コンストラクター関数の戻り値がオブジェクトの場合　＝　コンストラクターのreturnが返すオブジェクトをインスタンスオブジェクトとして呼び出し元に返す
// コンストラクター関数の戻り値がオブジェクト以外（もしくは戻り値が定義されていない）の場合　＝　コンストラクターのprototypeのプロパティを__proto__にコピーし、コンストラクター内の'this'を呼び出し元へ返却
//を以下に記述
// まずprototypeをコピーする
